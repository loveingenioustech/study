...
import catalog.ArticleType;
import catalog.CatalogType;
import catalog.JournalType;
...
public class CatalogJAXB2UnMarshaller {
	...
	public void unMarshall(File xmlDocument) {
		try {
			...
			JAXBContext jaxbContext = JAXBContext.newInstance("catalog");
			Unmarshaller unMarshaller = jaxbContext.createUnmarshaller();
			SchemaFactory schemaFactory = SchemaFactory
					.newInstance("http://www.w3.org/2001/XMLSchema");
			Schema schema = schemaFactory
					.newSchema(new File("src/catalog.xsd"));
