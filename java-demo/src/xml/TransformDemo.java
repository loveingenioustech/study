...
public class TransformDemo {
	public static void main(String[] args) throws Exception {
		...
		File styleSheet = new File(TransformDemo.class.getResource(filename)
				.getFile());
		...
		t.transform(
				new SAXSource(new EmployeeReader(), new InputSource(
						new FileInputStream(TransformDemo.class.getResource(
								"employee.dat").getFile()))), new StreamResult(
						System.out));
