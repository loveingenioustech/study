...
/**
 * This server program activates two remote objects and registers them with the
 * naming service.
 */
public class ProductActivator {
	public static void main(String args[]) {
		try {
			...
			// we use toURI so that spaces and other special characters in file
			// names are escaped
			String classURL = new File(classDir).getCanonicalFile().toURI()
					.toString();

			ActivationDesc desc1 = new ActivationDesc(id, "ProductImpl",
					classURL, p1param);
			ActivationDesc desc2 = new ActivationDesc(id, "ProductImpl",
					classURL, p2param);
			...
			System.out
					.println("Binding activable implementations to registry...");
