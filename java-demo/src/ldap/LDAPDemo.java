...
class LDAPFrame extends JFrame {
	...
	/**
	 * Gets a context from the properties specified in the file
	...
	public static DirContext getContext() throws NamingException, IOException {
		...
		InputStream in = LDAPDemo.class
				.getResourceAsStream("ldapserver.properties");
...
class DataPanel extends JPanel {
	 ...
	 * 
	 * @param attributes
	 *            the attributes of the given entry
	 */
